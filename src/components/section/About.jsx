      ...
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className=" rounded-b-xl p-8 border-white/10 border hover:-translate-y-1 transition-all">
          <p className="text-gray-300 mb-6">
            about
            paraasfasagafbdfashsasgasdasdsdasdgsadasgdasgdvfasasgdvczvsfdsgdasdgasgdasdgsag
          </p>
            ...
            <div className="rounded-xl p-6 hover:-translate-y-1 transition-all">
              ...
              <div className="flex flex-wrap gap-2">
                {frontendSkills.map((tech, key) => (
                  <span
                    key={key}
                    className="bg-blue-500/10 text-blue-500 py-1 px-3 rounded-full text-sm hover:bg-blue-500/20 hover:shadow-[59,130,246,0.2] transition"
                  >
                    {tech}
                  </span>
                ))}
